...
# Introduction
In this case study BellaBeat has hired me as a junior data analist. BellaBeat is a high-tech manufacturer of health-focused
 products for women. They sell several smart devices tracking activity, sleep, stress, and reproductive health. My task is to identfy trends found in fitness data gathered by Fitbits, so not their own devices. By doing this they hope to be able to improve their marketing strategy. 
...
**Act:** Give recommendations to BellaBeatc to improve their marketing campaign. 
...
The following are the stakeholders for which this raport is made and will be presented to:
...
* There is only data from 30 participants.  
